...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/macacohidraulico158,67.png" alt="" id="produtoImg">

                        </div>
                        

                        <div class="col-2">
                            <p>Macaco Hidraulico</p>
                            ...
                            <form action="" method="post">
                                ...
                                <br>
                                <a href="carrinho.php">
                                <button class="btn-adicionar" onclick="adicionarAoCarrinho('Macaco Hidraulico', 130.00)">Adicionar ao Carrinho</button>
                           </a>
                            </form>

                            <h3>Descrição:</h3>
                            <p>Macaco Hidraulico de ótima qualidade!</p>
                        </div>
