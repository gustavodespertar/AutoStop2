...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/algumacoisa.jpg" alt="" id="produtoImg">
                        ...
                        <div class="col-2">
                            ...
                            <form action="" method="post">
                                ...
                                <a href="carrinho.php">
                                <button class="btn-adicionar" onclick="adicionarAoCarrinho('Bicos Injetores', 997.90)">Adicionar ao Carrinho</button>
                                </a>
                            </form>

                            <h3>Descrição:</h3>
                            <p>Bicos Injetores de ótima qualidade!</p>
                        </div>
                ...
                <div class="corpo-categorias">
                    ...
                    <div class="linha">
                        ...
                        <div class="col-4">
                            <img src="assets/img/correiadentada.jpg" alt="">
