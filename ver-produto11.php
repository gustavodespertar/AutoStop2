...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/freioadisco368,00.jpg" alt="" id="produtoImg">
                        ...
                        <div class="col-2">
                            ...
                            <form action="" method="post">
                                ...
                                <br>
                                <a href="carrinho.php">
                                <button class="btn-adicionar" onclick="adicionarAoCarrinho('Freio a disco', 330.00)">Adicionar ao Carrinho</button>
                            </a>
                            </form>

                            <h3>Descrição:</h3>
                            <p>Freio a disco de ótima qualidade!</p>
                        </div>
