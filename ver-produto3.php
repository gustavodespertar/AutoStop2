...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/motor2.webp" alt="" id="produtoImg">

                        </div>
                        

                        <div class="col-2">
                            <p>Motor á gasolina para fusca</p>
                            ...
                            <form action="" method="post">
                                ...
                                <br>
                                <a href="carrinho.php">
                                <button class="btn-adicionar" onclick="adicionarAoCarrinho('Motor á gasolina para fusca', 999.90)">Adicionar ao Carrinho</button>
</a>
                            </form>

                            <h3>Descrição:</h3>
                            <p>Um Motor de ótima qualidade!</p>
