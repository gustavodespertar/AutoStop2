...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="assets/img/pneus.jpg" alt="" id="produtoImg">
                        ...
                        <div class="col-2">
                            ...
                            <form action="" method="post">
                                ...
                                <br>
                                <a href="carrinho.php">
                                <button class="btn-adicionar" onclick="adicionarAoCarrinho('Pneu Aro 16 Uni', 464.00)">Adicionar ao Carrinho</button>
                            </a>
                            </form>

                            <h3>Descrição:</h3>
                            <p>Pneu Aro 16 de ótima qualidade!</p>
                        </div>
