...
<body>
    ...
    <div class="corpo-categorias">
        ...
        <div class="linha">
            ...
            <div class="col-4">
                <img src="assets/img/embreagem.jpg" alt="">
            ...
            <div class="col-4">
                ...
                <button class="btn-adicionar" onclick="adicionarAoCarrinho('Bobina de Ignição', 1500.00)">Adicionar ao Carrinho</button>
            ...
            <div class="col-4">
                ...
                <p>R$ 30,00</p>
                <button class="btn-adicionar" onclick="adicionarAoCarrinho('lona de freio', 30.00)">Adicionar ao Carrinho</button>
